...
class ULPIDataTranslator(Elaboratable):
...
class UMTITranslator(Elaboratable):
    ...
    def elaborate(self, platform):
        ...
        dir_rising_edge = rising_edge_detector(m, self.ulpi.dir)
        ...
        # Data-out: we'll connect this directly through from our ULPI
        # interface, as it's essentially the same as in the UMTI spec.
